##source code : https://github.com/agalea91/twitter_search/blob/master/twitter_search.py
...
def main():
    ...
    Location = '5.6573,50.818287,5.862435,50.877518'  #Geocode from https://boundingbox.klokantech.com/
